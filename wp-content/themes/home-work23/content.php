    ...
    <div class="header-inner">
        ...
        <div class="header-overlay">
            <div class="header-content">
                ...
                <h2 class="header-slide">WE GENERATE</br>
                    <span>MOST CREATIVE</span></br>
                    IDEA</h2>
        ...
        <div class="container">
            ...
            <div id="navbar" class="navbar-collapse collapse">
                <ul id="top-menu" class="nav navbar-nav main-nav menu-scroll">
                    <li class="active"><a href="wordpress/index/">Home</a></li>
                            ...
                            <div class="testimonial-slider">
                                ...
                                <div class="single-slide">
                                    ...
                                    <div class="single-testimonial">
                                        <img class="testimonial-thumb" src="<?php bloginfo('template_directory'); ?>/assets/images/testimonial-image1.png" alt="img">
                                        <p>Jonna Hike</p>
                                ...
                                <div class="single-slide">
                                    <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamcoquat. Duis aute irure d olor in reprehenderit</p>
                                    <div class="single-testimonial">
                                        <img class="testimonial-thumb" src="<?php bloginfo('template_directory'); ?>/assets/images/team-member2.png" alt="img">
                                        <p>Jonna Hike</p>
                                        <span>CEO, Themeforest</span>
                                    </div>
                                </div>
                        ...
                        <div class="row">
                            <div class="col-md-4">
                                <article class="single-from-blog">
                                    <figure>
                                        <h2><a href="wordpress/blog-single/"><img src="<?php bloginfo('template_directory'); ?>/assets/images/the-sky.jpg" alt="img"></a>
                                    </figure>
                            ...
                            <div class="col-md-4">
                                <article class="single-from-blog">
                                    <figure>
                                        <h2><a href="wordpress/blog-single/"><img src="<?php bloginfo('template_directory'); ?>/assets/images/photographer.jpg" alt="img"></a>
                                    </figure>
                                    <div class="blog-title">
                                        <h2><h2><a href="wordpress/blog-single/">Here is the post title</a></h2>
                                        <p>Posted by <a class="blog-admin" href="#">admin</a> on <span class="blog-date">23rd july 2015</span></p>
                                    </div>
                                    <p>Sed ut perspiciatis unde mnis is te natus error sit voluptatem accusantium doloremque laudantium, totam rem aperiam, eaque ipsa quae ab illo inventore veritatis </p>
                                    <div class="blog-footer">
                            ...
                            <div class="col-md-4">
                                <article class="single-from-blog">
                                    <figure>
                                        <h2><a href="wordpress/blog-single/"><img src="<?php bloginfo('template_directory'); ?>/assets/images/sealand.jpg" alt="img"></a>
                                    </figure>
                                    <div class="blog-title">
                                        <h2><a href="wordpress/blog-single/">Here is the post title</a></h2>
                                        <p>Posted by <a class="blog-admin" href="#">admin</a> on <span class="blog-date">23rd july 2015</span></p>
            ...
            <div class="col-md-12">
                <div class="client-area">
                    <ul class="client-table">
                        <li><img src="<?php bloginfo('template_directory'); ?>/assets/images/envato.png" alt="client logo"></li>
                        <li><img src="<?php bloginfo('template_directory'); ?>/assets/images/google.png" alt="client logo"></li>
                        <li><img src="<?php bloginfo('template_directory'); ?>/assets/images/amazon.png" alt="client logo"></li>
                        <li><img src="<?php bloginfo('template_directory'); ?>/assets/images/discovery.png" alt="client logo"></li>
                        <li><img src="<?php bloginfo('template_directory'); ?>/assets/images/envato.png" alt="client logo"></li>
                        <li><img src="<?php bloginfo('template_directory'); ?>/assets/images/tuenti.png" alt="client logo"></li>
                        <li><img src="<?php bloginfo('template_directory'); ?>/assets/images/envato.png" alt="client logo"></li>
                        <li><img src="<?php bloginfo('template_directory'); ?>/assets/images/google.png" alt="client logo"></li>
                        <li><img src="<?php bloginfo('template_directory'); ?>/assets/images/amazon.png" alt="client logo"></li>
                        <li><img src="<?php bloginfo('template_directory'); ?>/assets/images/discovery.png" alt="client logo"></li>
